...
import {Records, TradeMarkResponseData, TradeMark} from "@/api/product/trademark/type.ts";
...
<template>
  <div>
    <el-card class="box-card">
      <!--    卡片顶部的添加品牌按钮-->
      <el-button type="primary" size="default" @click="addTrademark" icon="Plus">添加品牌
      </el-button>
      <!--    表格组件,用于展示已有的品牌数据-->
